...
<p>
  <img src="https://skillicons.dev/icons?i=angular,ts,js,html,css,sass,dotnet&perline=7" />
</p>
<p>
  <img src="https://skillicons.dev/icons?i=tailwind,bootstrap,astro,git,bitbucket,jenkins,github&perline=7" />
</p>
...
`Angular v14–18` &nbsp; `Ionic / Capacitor` &nbsp; `NgRx` &nbsp; `RxJS` &nbsp; `Astro`  
`TypeScript` &nbsp; `SASS` &nbsp; `Tailwind CSS` &nbsp; `CI/CD` &nbsp; `SonarCloud`

### Statistics

<p>
  <img src="https://github-readme-streak-stats.herokuapp.com?user=TkachukRR&theme=transparent&hide_border=true&ring=D97706&fire=D97706&currStreakLabel=D97706" alt="GitHub Streak" />
</p>
